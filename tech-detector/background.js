...
const VT_API_KEY         = "d487da2f1d9b2f771cc7776b3eb66743ed1cca8fe919d5c4d6833d0ff35fd9ac";   // leave "" to skip
const CHECKPHISH_API_KEY = "pol3lx6dtek9vesjf6l25hhbxkonm04lemnd43utnuwdwz7rk990tff80olx1wot";   // leave "" to skip
...
function heuristicCheck(url) {
  try {
    ...
    if      (risk >= 70) return " Not Safe (Heuristic)";
    else if (risk >= 40) return " Suspicious (Heuristic)";
    else if (risk >= 20) return " Unrecognized (Heuristic)";
    else                 return " Likely Safe (Heuristic)";
